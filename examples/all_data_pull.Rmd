...
for(i in c(1, 4, 12, 20, 40)){
  date_range = build_lagged_date_range_df(start_date = '2008-12-31',
...
ports_itd = calc_all(start_date = start_date,
                     end_date = end_date,
                     itd = TRUE,
                     nav_daily = nav_daily,
                     cf_daily = cf_daily,
...
categs_itd = calc_all(start_date = start_date,
                      end_date = end_date,
                      itd = TRUE,
                      nav_daily = nav_daily,
                      cf_daily = cf_daily,
...
funds_itd = calc_all(start_date = start_date,
                     end_date = end_date,
                     itd = TRUE,
                     nav_daily = nav_daily,
                     cf_daily = cf_daily,
