...
test_that("get_pm_fund_info() returns matching tibble", {
  ...
  pm_fund_info_raw <- get_pm_fund_info_raw()
  expected_columns <- c(
  ...
  expect_equal(colnames(pm_fund_info_raw), expected_columns)
  expect_equal(as.character(lapply(pm_fund_info_raw, class)), c("numeric", "character", "character", "character", "character", "character", "character",
                                                            "character", "character", "character", "numeric",   "numeric" ,  "numeric",
                                                            "character", "character", "Date",  "Date", "numeric",   "numeric",
                                                            "numeric", "character", "character", "logical", "logical",   "numeric" ,
                                                            "character"))
  expect_true(dplyr::count(pm_fund_info_raw) %>% dplyr::pull(n) >= 285)
  ...
  expect_equal(as.character(lapply(pm_fund_info, class)), c("numeric", "character", "character", "character", "character", "character", "character",
                                                            "character", "character", "character", "numeric",   "numeric" ,  "numeric",
                                                            "character", "character", "Date",  "Date", "numeric",   "numeric",
                                                            "numeric", "character", "character", "logical", "logical",   "numeric" ,
                                                            "character"))
  expect_true(dplyr::count(pm_fund_info) %>% dplyr::pull(n) >= 285)
})
