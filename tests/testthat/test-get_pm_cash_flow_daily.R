...
test_that("get_pm_cash_flow_daily() returns matching tibbles", {
  ...
  expected_names <- c(
     "effective_date", "cash_flow", "contributions",
  ...
  expect_equal(as.character(lapply(cf, class)), c("Date", "numeric", "numeric", "numeric", "character", "character", "character", "integer", "integer", "integer", "character", "character", "Date", "Date", "numeric", "numeric", "numeric", "character", "character", "logical", "logical", "numeric", "character", "character", "character", "character", "character", "character", "character"))
