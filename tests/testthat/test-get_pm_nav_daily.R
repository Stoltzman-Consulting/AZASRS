...
test_that("get_pm_nav_daily() matches test data", {
  ...
  expected_names <- c(
     "effective_date", "nav", "pm_fund_id", "pm_fund_description",
  ...
  expect_equal(as.character(lapply(pm_nav_daily, class)), c("Date", "numeric", "character", "character", "character", "integer", "integer", "integer", "character", "character", "Date", "Date", "numeric", "numeric", "numeric", "character", "character", "logical", "logical", "numeric", "character", "character", "character", "character", "character", "character", "character"))
